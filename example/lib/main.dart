...
// }
void main() async {
  final qbUuid = QueryBuilder(table: 'users'); // table with UUID primary key
  // final qbAuto =
  //     QueryBuilder(table: 'users_auto'); // table with auto-increment PK
  ...
  //   'name': 'Auto User',
  // });
  // print('Inserted user with auto-increment ID');
  print('Insert finished!');
  await DB.close(); // Close connection to allow Dart process to exit
  // Update user
  // await qbUuid.where('email', '=', 'uuid_user@test.com').update({
  //   'name': 'Updated UUID User',
  // });
